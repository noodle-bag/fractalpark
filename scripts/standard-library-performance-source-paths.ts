export const STANDARD_LIBRARY_PERFORMANCE_SOURCE_PATHS_V1 = [
  ...
  "src/app/api/creation/custom-formulas/lifecycle/route.ts",
  "src/app/sitemap.ts",
  "src/components/fractal/FractalCanvas.tsx",
  "src/components/fractal/FormulaPanel.tsx",
  "src/components/fractal/CustomFormulaList.tsx",
  "src/components/fractal/FormulaEditor.tsx",
  ...
  "src/hooks/useCloudFormulaLibrary.ts",
  "src/engine/frm/codemirror-lint.ts",
  "src/lib/cloud/client.ts",
  "src/lib/cloud/custom-formulas.ts",
  "src/lib/cloud/mine-formula-lifecycle.ts",
  ...
  "src/lib/held-formula-record-route.ts",
  ...
  "src/engine/formulas/v1/record-provenance.ts",
  ...
  "src/engine/plugins/builtins/index.ts",
  "src/test/document-v3-envelope-v2.test.ts",
  "src/test/document-adapter.test.ts",
  "src/test/formula-panel.test.tsx",
  "src/test/julia-capability-census.test.ts",
  "src/test/julia-runtime-activation-v1.test.ts",
  "src/test/julia-runtime-consumer-inventory.test.ts",
  ...
  "src/test/cloud-custom-formulas-routes.test.ts",
  "src/test/mine-formula-lifecycle-migration.test.ts",
  "src/test/mine-formula-lifecycle-route.test.ts",
  "src/test/mine-formula-lifecycle.test.ts",
  "src/test/published-formula-remix.test.ts",
  "src/test/use-cloud-formula-library.test.tsx",
  "src/test/formula-records.test.ts",
  "src/test/formula-record-panel.test.tsx",
  "src/test/formula-record-provenance.test.ts",
  ...
  "scripts/build-julia-runtime-activation-v1.ts",
  "scripts/verify-julia-runtime-activation-v1.ts",
